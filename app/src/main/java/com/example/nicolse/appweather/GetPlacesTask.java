...
import com.example.nicolse.appweather.Fragments.FragmentListPlaces;
...
public class GetPlacesTask extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String json) {
        ...
        if (json != null) {
            ...
            //callback.mostrarToast(String.valueOf(listGeonames.size()));//PlacesListAdapter adapter = new PlacesListAdapter( this.context,listGeonames);
            //listView.setAdapter(adapter);//esta listview viene del activity



          /*  Fragment newFragment = new FragmentListPlaces();
